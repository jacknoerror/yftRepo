...
//	private final String[] nAMESs = new String[]{"产 品","企 业","人 脉"};
	...
	public void initView() {
		...
		emptyTextView = MyJackListView.getEmptyTextView(getActivity(), "");
...
//		frameContainer.removeAllViews();
		...
		if(currentJlv.getType()==Type.IP_LOCALHISTORY&&null!=emptyTextView) currentJlv.setEmptyView(emptyTextView);//0707
	}
