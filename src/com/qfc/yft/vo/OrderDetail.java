...
public class OrderDetail extends JsonImport{
	...
	private OrderCompany companyInfo;
	private int orderId;
	...
	private String otherOrderStatusCh;
	private DateJson confirmTime;
	 
	
	
	public final String getOtherOrderStatusCh() {
		if(null==otherOrderStatusCh||otherOrderStatusCh.isEmpty()) otherOrderStatusCh = "ÔÝÎÞ";//0707
		return otherOrderStatusCh;
	}



	public final void setOtherOrderStatusCh(String otherOrderStatusCh) {
		this.otherOrderStatusCh = otherOrderStatusCh;
	}



	public final DateJson getConfirmTime() {
		return confirmTime;
	}



	public final void setConfirmTime(DateJson confirmTime) {
	...
	public final OrderCompany getCompanyInfo() {
		return companyInfo;
	}



	public final void setCompanyInfo(OrderCompany companyInfo) {
	...
	public void initJackJson(JSONObject job) throws JSONException {
		...
		if(job.has("companyInfo")) companyInfo = new OrderCompany(job.getJSONObject("companyInfo"));
		...
		//ÓÐ?
		if(job.has("otherOrderStatusCh")) otherOrderStatusCh = job.getString("otherOrderStatusCh");
		if(job.has("confirmTime")) confirmTime = new DateJson(job.getJSONObject("confirmTime"));
