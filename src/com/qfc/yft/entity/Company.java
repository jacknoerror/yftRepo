...
//			return "";
	...
	public String getCompCorpMobile() {
		...
		if(compCorpMobile.equals("null")) compCorpMobile=YftValues.NO_DATA;//1203
	...
	public String getCompLatitude() {
		...
		if(compLatitude.isEmpty()||compLatitude.equals(YftValues.NO_DATA)) compLatitude = YftValues.LOC_DEFAULT_LAT;
		return compLatitude;
	}
	public String getCompLongitude() {
		compLongitude = getThisThingFromItselfOrJson(compLongitude, "compLongitude");
		if(compLongitude.isEmpty()||compLongitude.equals(YftValues.NO_DATA)) compLongitude = YftValues.LOC_DEFAULT_LON;
