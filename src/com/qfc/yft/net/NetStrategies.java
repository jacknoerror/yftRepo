...
public class NetStrategies implements NetConst{
	...
	public static Map<String, String> getBasicParamMapInstance(String apiName){
		...
		paramKV.put(URL_APPKEY,_UF.getApp_key());
		paramKV.put(URL_BUSICODE, apiName);
		paramKV.put(URL_TIMESTAMP, JackUtils.getTimeStamp());//TODO 时区
//		String sessionKey = PLData.data().getSessionKey();
//		if(null!=sessionKey&&!sessionKey.isEmpty())paramKV.put(OPEN_API_SESSION_KEY, sessionKey);//sessionkey
		return paramKV;
	}
