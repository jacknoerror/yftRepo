	...
	public void onClick(View v) {
		...
		case R.id.btn_face:
			...
			if (view.getVisibility() == View.VISIBLE) {
				...
				getIMM().hideSoftInputFromWindow(v.getWindowToken(), InputMethodManager.HIDE_NOT_ALWAYS);//taotao 20131223
			}
	...
	private void Init_View() {
		...
		et_sendmessage.setOnFocusChangeListener(new View.OnFocusChangeListener() {
			...
			public void onFocusChange(View v, boolean hasFocus) {
				...
				Log.i("etsendmess", hasFocus+":focus");
			}
		});
		findViewById(R.id.btn_face).setOnClickListener(this);
		view = findViewById(R.id.ll_facechoose);

		et_sendmessage.requestFocus();//taotao 20131223  request focus, or there is sth wrong with keyboard and faceView
	}
