...
public class ProductManageActivityTest extends ActivityInstrumentationTestCase2<ProductManageActivity> {

	public ProductManageActivityTest(){
		super(ProductManageActivity.class);
	}
